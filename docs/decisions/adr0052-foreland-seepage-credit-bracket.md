...
- Every number here is matrix-reading. The bulk reading was **not** run: the
  driver supports `--reading bulk` and the arms would be another twelve full-N
  sweeps, which did not fit this session. That is an omission of scope, stated,
  not a finding.
